...
import numpy as np
import torch
from torch import optim, distributed as dist, nn
from ultralytics import __version__
from ultralytics.cfg import get_cfg, get_save_dir
from ultralytics.data.utils import check_cls_dataset
from ultralytics.nn import attempt_load_one_weight, attempt_load_weights
from ultralytics.utils import DEFAULT_CFG, RANK, yaml_save, callbacks, colorstr, TQDM, emojis, clean_url, yaml_load, \
    DATASETS_DIR
from ultralytics.utils.autobatch import check_train_batch_size
from ultralytics.utils.checks import print_args, check_model_file_from_stem, check_imgsz, check_file, check_amp
from ultralytics.utils.dist import generate_ddp_command, ddp_cleanup
from ultralytics.utils.files import get_latest_run
from ultralytics.utils.torch_utils import select_device, init_seeds, one_cycle, ModelEMA, EarlyStopping, \
    convert_optimizer_state_dict_to_fp16, strip_optimizer
...
class BaseTrainer:
    ...
    @staticmethod
    def check_det_dataset(dataset, verbose: bool = True):
        """
        ...
        Args:
            ...
            verbose (bool, optional): Whether to print dataset information. Defaults to True.

        Returns:
            (dict): Parsed dataset information and paths.
        """
        # Read YAML
        file = check_file(dataset)  # check file exists
        ...
        # Set paths
        data['path'] = path
        data['train'] = path / data['train']
        data['val'] = path / data.get('val', data.get('test', data['train']))  # 'val' is 'test' if absent
    ...
    def get_dataset(self):
        ...
        try:
            if self.args.task == "classify":
                ...
                data = self.check_det_dataset(self.args.data)
