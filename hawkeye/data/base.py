...
from ultralytics.data.utils import FORMATS_HELP_MSG, HELP_URL, IMG_FORMATS, exif_size
from ultralytics.utils import DEFAULT_CFG, LOCAL_RANK, NUM_THREADS, TQDM
...
class BaseDataset(Dataset):
    ...
    def __init__(
        ...
        # Check if only labels are required
